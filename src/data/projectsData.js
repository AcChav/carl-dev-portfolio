export const projectsData = [
  {
    ...
    category: "Full-Stack",
    description:
      "Recruitment portal built for Bayloni Services to streamline applicant tracking, candidate submissions, and job postings.",
  ...
  },
  {
    ...
    category: "CLI",
    description:
      "Console utilities implementing tiered billing calculators, and cart simulation.",
    tech: ["C++", "CLI"],
  ...
  },
  {
    ...
    category: "Backend",
    description:
      "Stateless REST API implementing JWT authentication, secure password hashing, and parameterized database queries.",
  ...
  },
  {
    ...
    description:
      "Clean portfolio highlighting core semantic layout, accessibility standards, responsive styling, and modern UI design.",
